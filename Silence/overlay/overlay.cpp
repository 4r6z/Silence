...
#include "../utils/imgui/imgui_toggle.h"
#include "../utils/imgui/imgui_impl_win32.h"
#include "../utils/imgui/imgui_impl_dx11.h"
#include <dwmapi.h>

#include "../../features/esp/esp.hpp"
#include "../../rbx/globals/globals.hpp"
		...
		ImGui::NewFrame();
		{

			{
				...
				if (draw)
				{
					...
					ImGui::Begin(("Silence"), nullptr, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoScrollbar);
					...
					if (tab == 2)
					{
						...
						ImGui::BeginChild(("SettingsChildWindow"), ImVec2(685, 340), true);
						{
							...
							if (ImGui::Button(("Open Folder Location")))
							{
...
{
	HWND target = FindWindowA("WINDOWSCLIENT", 0);
	if (!target) target = FindWindowA(0, ("Roblox"));
	if (!target) return;
